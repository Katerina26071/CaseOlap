        ...
        public async Task<ActionResult> Register(RegisterModel model) {
          if (ModelState.IsValid) {
            ...
            if (result.Succeeded) {
             ...
             // await SignInManagerExtensions.PasswordSignIn(user, model.Password, shouldLockout: false);//SignInManager.PasswordSignInAsync(user, isPersistent: false, rememberBrowser: false);
