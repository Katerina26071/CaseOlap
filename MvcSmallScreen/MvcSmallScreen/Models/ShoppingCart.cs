...
namespace MvcSmallScreen.Models
{
    public partial class ShoppingCart
    {
        ...
        {
            var cart = new ShoppingCart(); cart.ShoppingCartId = cart.GetCartId(context);
            return cart;
        }
        // Вспомогательный метод для упрощения корзины
        ...
        public void AddToCart(Goods goods)
        {
            ...
            if (cartItem == null)
            {
                // Создать новый товар в корзине, если нет продуктов существует 
                cartItem = new Cart
                {
        ...
        public decimal GetTotal()
        {
            ...
            decimal? total = (from cartItems in storeDB.Carts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.Goods.Price).Sum();
